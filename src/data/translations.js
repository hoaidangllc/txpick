...
export const translations = {
  en: {
    appName: 'TxPick',
    taglineMain: 'TxPick remembers for you',
    taglineSub: 'Smart daily reminders for medication, bills, family, and more — in Vietnamese & English.',
    ...
    nav: {
      ...
      ai: 'AI Agent',
      logout: 'Log out',
      elderMode: 'Big text mode',
    },

    today: {
      title: 'Today',
      quickPlaceholder: 'Type a reminder… e.g. "Remind me to take my pills at 9 PM"',
      addBtn: 'Add reminder',
      empty: 'No reminders yet. Try the quick add above!',
      ...
      markUndone: 'Undo',
      delete: 'Delete',
      summaryOne: 'You have 1 reminder today.',
      summaryMany: 'You have {n} reminders today.',
      overdueOne: '1 reminder is overdue.',
      overdueMany: '{n} reminders are overdue.',
      forPerson: 'For',
      repeats: 'Repeats',
      noTime: 'No time set',
    },
    remind: {
      ...
      titlePh: 'Take pills, call mom, pay electric bill…',
      when: 'When',
      time: 'Time',
      date: 'Date',
      category: 'Category',
    ...
    hero: {
      eyebrow: 'Built for families, elders & small shops',
  ...
  vi: {
    appName: 'TxPick',
    taglineMain: 'TxPick nhớ giùm bạn',
    taglineSub: 'Nhắc thuốc, hóa đơn, lịch hẹn, gia đình — bằng tiếng Việt và tiếng Anh.',
    ...
    nav: {
      ...
      ai: 'AI',
      logout: 'Đăng xuất',
      elderMode: 'Chế độ chữ to',
    },

    today: {
      title: 'Hôm nay',
      quickPlaceholder: 'Nhập một câu nhắc… ví dụ "Nhắc tôi uống thuốc lúc 9 giờ tối"',
      addBtn: 'Thêm nhắc nhở',
      empty: 'Chưa có nhắc nhở nào. Hãy thử ô nhập nhanh ở trên!',
      ...
      markUndone: 'Hoàn tác',
      delete: 'Xóa',
      summaryOne: 'Hôm nay bạn có 1 việc cần nhớ.',
      summaryMany: 'Hôm nay bạn có {n} việc cần nhớ.',
      overdueOne: '1 việc đã quá hạn.',
      overdueMany: '{n} việc đã quá hạn.',
      forPerson: 'Cho',
      repeats: 'Lặp lại',
      noTime: 'Chưa đặt giờ',
    },
    remind: {
      newTitle: 'Nhắc nhở mới',
      title: 'Cần nhớ gì?',
      titlePh: 'Uống thuốc, gọi mẹ, trả tiền điện…',
      when: 'Khi nào',
      time: 'Giờ',
      date: 'Ngày',
      category: 'Phân loại',
      ...
      notifOn: 'Đã bật thông báo',
      notifBlocked: 'Thông báo bị chặn — vào cài đặt trình duyệt để bật.',
    },

    hero: {
      eyebrow: 'Dành cho gia đình, người lớn tuổi & tiệm nhỏ',
