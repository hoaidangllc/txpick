...
const copy = {
  vi: {
    ...
    sub: 'TXPick đang được hoàn thiện từ góp ý thật. Bạn cần app nhắc gì tốt hơn, dễ hơn, hoặc hữu ích hơn mỗi ngày?',
    badge: 'Góp ý của bạn giúp app dễ dùng hơn',
    ...
    subjectPlaceholder: 'Ví dụ: cần nhắc hóa đơn mạnh hơn trên iPhone',
    ...
    whyText: 'TXPick đang ưu tiên làm các phần cốt lõi thật chắc: nhắc việc, chi tiêu, hóa đơn, business, thuế và thông báo trên điện thoại. Góp ý của bạn giúp app đi đúng nhu cầu thực tế.',
    categories: {
  ...
  en: {
    ...
    sub: 'TXPick is being improved with real feedback. What would make reminders, bills, business, or phone use easier for you?',
    badge: 'Your feedback helps make TXPick easier',
    ...
    whyText: 'TXPick is focusing on the core experience first: reminders, expenses, bills, business records, tax prep, and phone notifications. Your feedback helps shape what should come next.',
    categories: {
