...
const txt = {
  vi: {
    hello: 'Chào bạn, hôm nay mình làm gọn từng việc một.', title: 'Hôm nay', sub: 'Trang chính để xem việc cần nhớ, hóa đơn và chi tiêu trong ngày.',
    ...
    insight: 'Gợi ý hôm nay', cached: 'Lưu theo ngày • không gọi AI mỗi lần mở app', quick: 'Nhắc nhanh', add: 'Thêm', placeholder: 'Ví dụ: nhắc tôi trả tiền điện ngày mai 9pm', helper: 'Bạn có thể gõ câu tự nhiên. App sẽ xử lý trước bằng máy, không cần AI vẫn dùng được.', today: 'Cần làm hôm nay', noToday: 'Hôm nay chưa có việc cần nhớ.', fastAdd: 'Thêm nhanh', expense: 'Chi tiêu', monthlyBill: 'Hóa đơn hằng tháng', upcoming: 'Sắp tới', noUpcoming: 'Chưa có việc sắp tới.', limitReminder: 'Bạn đã đạt giới hạn nhắc việc của gói hiện tại.', limitExpense: 'Bạn đã đạt giới hạn chi tiêu của gói hiện tại.', noDate: 'Chưa chọn ngày', category: 'Phân loại', close: 'Đóng', save: 'Lưu', expenseTitle: 'Thêm chi tiêu', expenseName: 'Tên chi tiêu', amount: 'Số tiền', date: 'Ngày', billTitle: 'Thêm hóa đơn hằng tháng', billName: 'Tên hóa đơn', dueDay: 'Ngày đến hạn trong tháng', free: 'Miễn phí', basic: 'Pro Cơ Bản $1.99', premium: 'Pro Plus $4.99',
  },
  en: {
