...
const txt = {
  vi: {
    ...
    smartNeedsReview: 'Câu này hơi khó hiểu. Hãy kiểm tra lại ngày giờ và loại trước khi lưu.',
  ...
  en: {
    ...
    smartNeedsReview: 'This one is a bit unclear. Double-check the date, time, and category before saving.',
