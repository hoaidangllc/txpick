...
const copy = {
  vi: {
    ...
    sections: [
      ...
      ['Xuất hoặc xóa dữ liệu', 'Bạn có thể xuất thông tin business/tax trong app. Bạn cũng có thể xóa tài khoản trong Cài đặt. Nếu cần hỗ trợ thêm, hãy liên hệ email hỗ trợ.'],
  ...
  en: {
    ...
    sections: [
      ...
      ['Export or delete data', 'You can export business/tax information inside the app. You can also delete your account in Settings. For extra help, contact support.'],
