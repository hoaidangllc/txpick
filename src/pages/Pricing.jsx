...
const copy = {
  vi: {
    back: 'Quay lại',
    today: 'Về Hôm nay',
    title: 'Gói nâng cấp sắp ra mắt',
    sub: 'Bạn vẫn có thể dùng TXPick miễn phí trong thời gian đầu. Plus và Pro sẽ mở sau khi trải nghiệm ổn định hơn.',
    bill: 'Sắp ra mắt • hiện chưa thu phí',
    popular: 'Dành cho chủ tiệm / Uber / DoorDash',
    current: 'Gói hiện tại',
    pickFree: 'Giữ gói Free',
    pickPaid: 'Sắp ra mắt',
    confirmTitle: 'Đã giữ gói Free',
    confirmText: 'Plus và Pro sẽ mở sau. Hiện tại bạn có thể tiếp tục dùng các tính năng miễn phí của TXPick.',
    close: 'Đóng',
    selected: 'Bạn đang xem',
    soon: 'Sắp ra mắt',
    noCharge: 'Hiện chưa thu phí',
    plans: [
      { key: 'free', name: 'Free', price: '$0', priceUnit: '', sub: 'Đủ để bắt đầu dùng mỗi ngày',
        features: ['Trang Hôm nay', 'Nhắc việc cơ bản', 'Chi tiêu cá nhân cơ bản', 'Hóa đơn hằng tháng', 'Smart Assistant giới hạn', 'Miễn phí trong giai đoạn đầu'],
  ...
  en: {
    ...
    sub: 'You can keep using TXPick for free during early access. Plus and Pro will open after the core experience is stable.',
    bill: 'Coming soon • no charge today',
    popular: 'For owners / Uber / DoorDash',
    current: 'Current plan',
    pickFree: 'Keep Free',
    pickPaid: 'Coming Soon',
    confirmTitle: 'Free plan kept',
    confirmText: 'Plus and Pro will open later. For now, you can keep using TXPick’s free tools.',
    close: 'Close',
    selected: 'Viewing',
    soon: 'Coming Soon',
    ...
    plans: [
      { key: 'free', name: 'Free', price: '$0', priceUnit: '', sub: 'Enough to start using it daily',
        features: ['Today page', 'Basic reminders', 'Basic personal expenses', 'Monthly bills', 'Limited Smart Assistant', 'Free during early access'],
