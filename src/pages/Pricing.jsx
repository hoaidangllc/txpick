  ...
  vi: {
    ...
    plans: [
      ...
      { key: 'premium', name: 'Pro Plus', price: '$4.99', priceUnit: '/tháng', sub: 'Cho gia đình, tiệm nail, Uber/DoorDash và business nhỏ',
        features: ['Không giới hạn nhắc việc', 'Không giới hạn chi tiêu', 'Tách cá nhân / kinh doanh', 'Tổng kết cuối năm để đưa cho thuế', 'Xuất CSV rõ ràng', 'Công cụ ưu tiên cho chủ business'],
  ...
  en: {
    ...
    plans: [
      ...
      { key: 'premium', name: 'Pro Plus', price: '$4.99', priceUnit: '/mo', sub: 'For families, nail salons, Uber/DoorDash, and small business',
        features: ['Unlimited reminders', 'Unlimited expenses', 'Personal/business split', 'Year-end summary for tax prep', 'Clean CSV export', 'Business-owner tools'],
