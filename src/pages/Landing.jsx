...
const copy = {
  vi: {
    ...
    title: 'TXPick',
    sub: 'App sắp xếp việc hằng ngày cho nhắc việc, hóa đơn, chi tiêu, payroll và công việc business nhỏ — gọn trong một nơi.',
  ...
  en: {
    ...
    title: 'TXPick',
    sub: 'Daily organizer for reminders, bills, expenses, payroll, and small business tasks — all in one simple app.',
