...
const copy = {
  vi: {
    ...
    note: 'Không AI chat vô hạn. Không scan hóa đơn. Không tư vấn thuế. Chỉ tập trung vào những việc bạn dùng mỗi ngày.',
  ...
  en: {
    ...
    note: 'No unlimited AI chat. No receipt scanning. No tax advice. Just the things you’ll actually use every day.',
    ...
    v2: ['Light AI only', 'Natural reminder parsing and short daily insights — no unlimited chatbot.'],
