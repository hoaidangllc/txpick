...
export default async function handler(req, res) {
  ...
  try {
    ...
    const envReady = Boolean((process.env.VITE_WEB_PUSH_PUBLIC_KEY || process.env.WEB_PUSH_PUBLIC_KEY) && process.env.WEB_PUSH_PRIVATE_KEY)
    ...
    return sendJson(res, 200, {
      ...
      envReady,
      checks: {
        hasAnySubscription: total > 0,
        hasEnabledSubscription: enabled > 0,
        hasCurrentDevice: hasThisEndpoint,
        hasPushKeys: envReady,
      },
